...
[Docusaurus](https://docusaurus.io) is our way of helping to make the creation of open source documentation easier (hopefully). We currently have [multiple open source projects using it](https://docusaurus.io/en/users.html), with many more planned. If you're interested in contributing to Docusaurus, hopefully, this document makes the process for contributing clear.
